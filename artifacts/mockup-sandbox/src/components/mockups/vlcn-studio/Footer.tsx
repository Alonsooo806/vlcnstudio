  ...
  return (
    <footer className="border-t border-white/10 mt-auto" style={{ background: 'rgba(13,0,32,0.85)' }}>
      <div className="max-w-[1400px] mx-auto px-6 md:px-16 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* ¿Quiénes somos? */}
        <div>
          <h4 className="font-mono text-xs font-bold tracking-widest text-white/70 mb-3 uppercase">¿Quiénes somos?</h4>
          <p className="text-white/50 text-sm leading-relaxed">
            Somos un taller técnico de Temuco especializado en estampado de alta densidad. Personalizamos tus prendas con diseños de personajes, series, artistas y logos propios. Calidad industrial, atención directa.
          </p>
        </div>
