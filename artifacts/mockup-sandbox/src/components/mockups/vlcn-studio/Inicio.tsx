    ...
    <div className="min-h-screen flex flex-col font-sans text-white"
      ...
      <header className="px-6 py-5 flex items-center justify-between border-b border-white/10"
        ...
        <div className="flex items-center gap-3">
          ...
          <EditableText id="header_brand" as="span" className="font-bold tracking-tighter text-xl">
            VLCN STUDIO
          </EditableText>
        </div>
        <EditableText id="header_location" as="span" className="font-mono text-xs text-white/30 hidden md:block">
          TEMUCO · CHILE
        </EditableText>
      </header>
      ...
      <section className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="flex flex-col justify-center px-8 md:px-20 py-20 lg:w-1/2 lg:min-h-screen">
          <EditableText id="hero_eyebrow" as="p" className="font-mono text-xs tracking-widest mb-6" style={{ color: '#c084fc' }}>
            PERSONALIZACIÓN PREMIUM · TEMUCO
          </EditableText>

          <EditableText id="hero_title_1" as="h1" className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] mb-2">
            TU DISEÑO
          </EditableText>
          <EditableText id="hero_title_2" as="h1" className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] mb-2" style={{
          ...
          <EditableText id="hero_title_3" as="h1" className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.9] mb-8">
            PRENDA.
          </EditableText>

          <EditableText id="hero_desc" as="p" className="text-white/55 text-lg leading-relaxed max-w-sm mb-12" multiline>
            Personajes, series, artistas, logos — o sube tu propio archivo. Elegimos el estampado, tú elijes el diseño.
          </EditableText>
          ...
          >
            <EditableText id="hero_cta" as="span">SEGUIR</EditableText>
          ...
          <div className="flex gap-8 mt-12">
            <div className="flex items-center gap-2 text-white/40">
              ...
              <EditableText id="trust_dtf" as="span" className="font-mono text-xs">DTF + SERIGRAFÍA</EditableText>
            </div>
            <div className="flex items-center gap-2 text-white/40">
              <ShieldCheck className="w-4 h-4 text-cyan-400" />
              <EditableText id="trust_wash" as="span" className="font-mono text-xs">50 LAVADOS</EditableText>
            </div>
            <div className="flex items-center gap-2 text-white/40">
              <Clock className="w-4 h-4 text-pink-400" />
              <EditableText id="trust_days" as="span" className="font-mono text-xs">4–5 DÍAS</EditableText>
            </div>
          </div>
        </div>
      ...
      <section className="px-8 md:px-20 py-10 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-6"
        ...
        <div>
          <EditableText id="wa_title" as="p" className="font-bold text-lg text-white mb-1">¿Tienes dudas?</EditableText>
          <EditableText id="wa_desc" as="p" className="text-white/50 text-sm">Te atendemos por WhatsApp — respuesta en minutos.</EditableText>
        </div>
        <a
          href={WA_URL}
          target="_blank"
        ...
        >
          ...
          <EditableText id="wa_button" as="span">ESCRÍBENOS</EditableText>
        </a>
      </section>
      ...
      <section className="px-8 md:px-20 py-8 border-t border-white/5"
        ...
        <EditableText id="info_eyebrow" as="p" className="font-mono text-[10px] tracking-widest text-white/25 mb-4 text-center">INFORMACIÓN IMPORTANTE</EditableText>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 max-w-4xl mx-auto">
          ...
          >
            ...
            <div>
              <EditableText id="info_quienes_title" as="p" className="font-mono text-xs font-bold tracking-wider text-white/70 group-hover:text-white transition-colors">¿QUIÉNES SOMOS?</EditableText>
              <EditableText id="info_quienes_desc" as="p" className="text-white/35 text-xs mt-0.5">Nuestra historia y contacto</EditableText>
            </div>
          </a>
          {/* Términos */}
          <a
          ...
          >
            ...
            <div>
              <EditableText id="info_terminos_title" as="p" className="font-mono text-xs font-bold tracking-wider text-white/70 group-hover:text-white transition-colors">
                TÉRMINOS Y CONDICIONES
              </EditableText>
              <EditableText id="info_terminos_desc" as="p" className="text-white/35 text-xs mt-0.5">Compra, garantía y devoluciones</EditableText>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <EditableText id="info_cuidado_title" as="p" className="font-mono text-xs font-bold tracking-wider text-white/70 group-hover:text-white transition-colors">
                CUIDADO DE TU PRODUCTO
              </EditableText>
              <EditableText id="info_cuidado_desc" as="p" className="text-white/35 text-xs mt-0.5">Lavado, secado y planchado DTF</EditableText>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <EditableText id="info_faq_title" as="p" className="font-mono text-xs font-bold tracking-wider text-white/70 group-hover:text-white transition-colors">
                PREGUNTAS Y RESPUESTAS
              </EditableText>
              <EditableText id="info_faq_desc" as="p" className="text-white/35 text-xs mt-0.5">DTF, compra, garantía y envíos</EditableText>
            </div>
          </a>
        </div>
      </section>
